...
public abstract class Vehicle : MonoBehaviour
{
    ...
    public Vector3 StayInBounds()
    {
        ...
        {
            //using worldBounds.x rather than worldBounds.y for the y value here because the world is a cube, but
           
            outOfBoundsCount++;
            return Flee(new Vector3(vehiclePosition.x, worldBounds.y, vehiclePosition.y)) * stayInBoundsWeight;
        }
