...
public abstract class Vehicle : MonoBehaviour
{
    ...
    int outOfBoundsCount = 0; //count how many frames this is out of bounds for
    ...
    protected void Update()
    {
        ...
        float targetVerticalAngle = Mathf.Atan2(direction.y, direction.x) * Mathf.Rad2Deg;
        ...
        transform.rotation = Quaternion.Euler(0, targetHorizontalAngle, 0);
