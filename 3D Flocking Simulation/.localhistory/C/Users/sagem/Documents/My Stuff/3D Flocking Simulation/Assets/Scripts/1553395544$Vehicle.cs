...
public abstract class Vehicle : MonoBehaviour
{
    ...
    protected void Update()
    {
        ...
        float targetVerticalAngle = Mathf.Atan2(direction.y, direction.z) * Mathf.Rad2Deg;
        ...
        transform.rotation = Quaternion.Euler(0, targetHorizontalAngle, targetVerticalAngle);
