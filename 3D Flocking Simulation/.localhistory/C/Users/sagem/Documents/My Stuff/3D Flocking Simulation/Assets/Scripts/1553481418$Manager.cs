...
public class Manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //using x twice here because we want the world to be a cube, and the max y of the terrain would be smaller than its x and z
        worldBounds = new Vector3(terrainData.bounds.max.x, terrainData.bounds.max.x, terrainData.bounds.max.z);
