...
public abstract class Vehicle : MonoBehaviour
{
    ...
    /// <summary>
    /// Returns a direction vector for all flockers to wander in based on whether they are 
    /// </summary>
    ...
    /// <summary>
    /// Returns a 2D direction vector for all flockers to wander in (actually just a Vector3 with y=0)
    /// </summary>
    public Vector3 SetFlockWander2()
    {
        if (wanderCountdown > 0)
        {
            wanderCountdown--;
    ...
    /// <summary>
    /// Returns the wandering force for the flocker to wander in the same direction as every other flocker
    /// </summary>
