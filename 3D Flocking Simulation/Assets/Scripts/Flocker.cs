...
public class Flocker : Vehicle {
    ...
    public override void CalcSteeringForces()
    {
        ...
        //destroy this game object if it goes out of bounds - it will mess with the flocking otherwise
        if(outOfBoundsCount > maxFramesOutOfBounds)
        {
